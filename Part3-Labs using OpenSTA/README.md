# Part 3 – Generate Timing Graphs with OpenSTA
  ...
  - [Understanding of OpenSTA tool](https://www.google.com/search?q=%23understanding-of-opensta-tool)
  ...
  - [Installation of OpenSTA](https://www.google.com/search?q=%23installation-of-opensta)
      ...
      - [Step 2: Run the OpenSTA Container](https://www.google.com/search?q=%23step-2-run-the-opensta-container)
  - [Walkthrough of a Basic Example](https://www.google.com/search?q=%23walkthrough-of-a-basic-example)
      - [Netlist](https://www.google.com/search?q=%23netlist)
      - [Commands to Enter](https://www.google.com/search?q=%23commands-to-enter)
      - [Output Received](https://www.google.com/search?q=%23output-received)
      - [Analysis of the Output](https://www.google.com/search?q=%23analysis-of-the-output)
  - [Performing STA on `VSDBabySoC` 📈](https://www.google.com/search?q=%23performing-sta-on-vsdbabysoc-)
      - [VSDBabySoC basic timing analysis](https://www.google.com/search?q=%23vsdbabysoc-basic-timing-analysis)
          - [Step 1: Prerequisites](https://www.google.com/search?q=%23step-1-prerequisites)
          - [Step 2: Correcting the error](https://www.google.com/search?q=%23step-2-correcting-the-error)
          - [Step 3: Run `.tcl` file in OpenSTA](https://www.google.com/search?q=%23step-3-run-tcl-file-in-opensta)
          - [Step 4: Analyze Your Report](https://www.google.com/search?q=%23step-4-analyze-your-report)
  - [VSDBabySoC PVT Corner Analysis](https://www.google.com/search?q=%23vsdbabysoc-pvt-corner-analysis)
      - [What is PVT Corner Analysis?](https://www.google.com/search?q=%23what-is-pvt-corner-analysis)
      - [PVT Analysis Tcl Script for OpenSTA](https://www.google.com/search?q=%23pvt-analysis-tcl-script-for-opensta)
          - [Step 1: Create the STA Tcl Script](https://www.google.com/search?q=%23step-1-create-the-sta-tcl-script)
          - [Step 2: Run the Analysis Using Docker](https://www.google.com/search?q=%23step-2-run-the-analysis-using-docker)
          - [Step 3: Create the Python Script for Plotting](https://www.google.com/search?q=%23step-3-create-the-python-script-for-plotting)
          - [Step 4: Run the Python Script to Generate Graphs](https://www.google.com/search?q=%23step-4-run-the-python-script-to-generate-graphs)
  - [Timing Summary Across PVT Corners](https://www.google.com/search?q=%23timing-summary-across-pvt-corners)
  - [Timing Plots and Analysis](https://www.google.com/search?q=%23timing-plots-and-analysis)
      - [Understanding the Results](https://www.google.com/search?q=%23understanding-the-results)
      - [1. Worst Min Slack (Hold slack)](https://www.google.com/search?q=%231-worst-min-slack-hold-slack)
      - [2. Worst Max Slack (Setup slack)](https://www.google.com/search?q=%232-worst-max-slack-setup-slack)
      - [3. Worst Negative Slack (WNS)](https://www.google.com/search?q=%233-worst-negative-slack-wns)
      - [4. Total Negative Slack (TNS)](https://www.google.com/search?q=%234-total-negative-slack-tns)

...
Here is the table of contents for the document you provided.
  ...
  - [Understanding of OpenSTA tool](#understanding-of-opensta-tool--)
      - [OpenSTA: Inputs and Outputs ⚙️](#1-opensta-inputs-and-outputs-%EF%B8%8F)
      - [The Synopsys Design Constraints (`.sdc`) File 📝](#2-the-synopsys-design-constraints-sdc-file-)
      - [Basic OpenSTA Commands ⚙️](#3-basic-opensta-commands-%EF%B8%8F)
      - [Starting OpenSTA](#4-starting-opensta)
      - [Walkthrough of a Basic Example](#5-walkthrough-of-a-basic-example)
  - [Performing STA on `VSDBabySoC` 📈](#performing-sta-on-vsdbabysoc-)
  - [VSDBabySoC PVT Corner Analysis](#vsdbabysoc-pvt-corner-analysis-post-synthesis-timing)
